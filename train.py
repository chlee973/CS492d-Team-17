...
from  sketch_diffusion.unet import UNetModel
from sketch_diffusion.gaussian_diffusion import GaussianDiffusion
...
def main():
    ...
    data = load_data(
        ...
        category=["cat"], # replace your own datasets name.
        class_cond=False,
    )

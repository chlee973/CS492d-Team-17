...
from sketch_diffusion.model_ensemble import DiffusionModule
...
def main(args):
    ...
    # ddpm.load("results/diffusion-ddim-11-28-031918-cat_1000step_vectors_transformer_16head/last.ckpt")
    ddpm.load2("results/diffusion-ddim-11-28-031906-cat_1000step_vectors_transformer_16head/last.ckpt","results/diffusion-ddim-11-28-053924-cat_1000step_vectors_transformer_16head/last.ckpt")
